...
namespace ui
{
    ...
    public:
        ...
        */
        ...
        bool CallJSDirect(std::string& js);
        ...
        */
        virtual bool AttachDevTools(Control* view);
        ...
        */
        ...
        CefRefPtr<nim_cef::BrowserHandler> GetBrowserHandler() { return browser_handler_; }
    protected:
    ...
    public:
        ...
        */
        ...
        void AttachFullScreenModeChange(const OnFullScreenModeChangeEvent& callback) { cb_fullscreen_mode_change_ = callback; }
        /**
        ...
        */
        ...
        void SetDebugMode(bool bDebug) { is_debug_ = bDebug; }
    protected:
    ...
    private:
        ...
        virtual bool OnExecuteCppFunc(const CefString& function_name, const CefRefPtr<CefListValue>& argList, int js_callback_id, CefRefPtr<CefBrowser> browser) OVERRIDE;
    ...
    protected:
        ...
        OnFullScreenModeChangeEvent cb_fullscreen_mode_change_ = nullptr;
